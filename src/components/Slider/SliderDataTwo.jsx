      ...
      <div className="container px-[1rem] pt-[3rem] lg:px-0 lg:mx-auto">
        <div className=" ">
          ...
          <div className="flex  justify-between mb-6  ">
            <div className="xxxs:pl-[.5rem] xm:pl-[1.8rem] ">Recommended</div>
            <div className="flex">
              <div className="text-orange-500 xxxs:pr-[.7rem] xm:pr-[1.50rem]">
                AddMore
              </div>
              <div>
                <button
          ...
          <div className="">
            {/* data Show */}
            <div className="grid grid-cols-2  md:grid-cols-5 lg:grid-cols-5 gap-4 xl:gap-9 ">
